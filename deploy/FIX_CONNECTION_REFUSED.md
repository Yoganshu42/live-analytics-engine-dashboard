...
2. Find instance with IP: **13.235.66.217**
...
- Frontend: http://13.235.66.217:3000
- Backend: http://13.235.66.217:8000/health
...
```powershell
# Test backend
curl http://13.235.66.217:8000/health

# Test frontend (should return HTML)
curl http://13.235.66.217:3000
```
...
3. On security group for instance **13.235.66.217**
...
- **Dashboard**: http://13.235.66.217:3000
- **API**: http://13.235.66.217:8000
- **Docs**: http://13.235.66.217:8000/docs
