...
### If build fails:
1. Check logs: `ssh -i deploy/ssh_key.pem ubuntu@13.235.66.217 "cd /home/ubuntu/live-dashboard && docker-compose logs"`
2. Check disk space: `ssh -i deploy/ssh_key.pem ubuntu@13.235.66.217 "df -h"`
3. Clean Docker cache: `ssh -i deploy/ssh_key.pem ubuntu@13.235.66.217 "docker system prune -af"`
