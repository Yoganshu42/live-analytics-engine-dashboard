...
### If build fails:
1. Check logs: `ssh -i deploy/ssh_key.pem ubuntu@43.205.134.36 "cd /home/ubuntu/live-dashboard && docker-compose logs"`
2. Check disk space: `ssh -i deploy/ssh_key.pem ubuntu@43.205.134.36 "df -h"`
3. Clean Docker cache: `ssh -i deploy/ssh_key.pem ubuntu@43.205.134.36 "docker system prune -af"`
